...
async function main() {
  ...
  console.log('Cleared subcategories table')
  ...
  const categories = [
    ...
    { id: 'ai-office', name: 'AI办公', icon: '💼', description: '利用AI提升工作效率，涵盖营销、编程、自动化等场景', sort: 1 },
    { id: 'ai-creation', name: 'AI创作', icon: '🎨', description: 'AI赋能创意工作，涵盖视频、图像、音频、文本生成', sort: 2 },
    { id: 'ai-life', name: 'AI生活', icon: '🏠', description: 'AI让生活更美好，涵盖健身、健康、宗教、时尚、礼物推荐、旅行、美食', sort: 3 },
